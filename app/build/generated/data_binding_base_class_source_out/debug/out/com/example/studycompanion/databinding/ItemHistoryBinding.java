...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  private ItemHistoryBinding(@NonNull LinearLayout rootView, @NonNull TextView textScore,
      @NonNull TextView textSubject) {
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemHistoryBinding((LinearLayout) rootView, textScore, textSubject);
    }
