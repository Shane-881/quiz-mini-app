...
public final class ItemNoteBinding implements ViewBinding {
  ...
  private ItemNoteBinding(@NonNull MaterialCardView rootView, @NonNull ImageView btnDelete,
  ...
  public static ItemNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNoteBinding((MaterialCardView) rootView, btnDelete, textContent, textTitle);
    }
